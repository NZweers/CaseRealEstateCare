    ...
    <v-card v-if="hasInspection">
        ...
        <v-card-text>
            <v-form ref="v-form " @submit.prevent="save()">
                ...
                <v-text-field v-model="inspection.location" name="location" label="Location" placeholder="Enter a location"
                required></v-text-field>
                <v-select v-model="inspection.installation_type" name="installation_type" label="Installation type"
                placeholder="Enter an installation type" required :items="['Koeling', 'Openhaard', 'Kraan', 'Elektra', 'Deuren', 'Douche']"></v-select>
                <v-textarea v-model="inspection.reported_failures" name="reported_failures" label="Failures" placeholder="Describe the failures"
                required></v-textarea>
                <v-textarea v-model="inspection.description" name="description" label="Description" placeholder="Describe the failures"
                required></v-textarea>
